...
// How the client speaks to the gateway. Its factory takes an LLMProtocol value name such as
// ANTHROPIC_MESSAGES, or the JSON of an envoy.type.ai.v3.DownstreamApi.
...
// The upstream a request is sent to. Its factory takes the JSON of an
// envoy.type.ai.v3.UpstreamTarget. Only trusted, config-driven writers may set it.
